...
mv_1        =  c(393.0512, 341.0188, 3092.0576, 1.5*117.4754)  # mean-value parameters for increased transitivity and tapered model
theta       =  c(-3.022, 1.53, -0.0663, 0.60) # increased trans theta
