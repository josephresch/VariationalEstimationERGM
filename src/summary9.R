...
if(T){
load("mfergm_params9_n1000_1.RData")
v1 <- mfergm_estim
...
load("mfergm_params9_n1000_2.RData")
...
load("mfergm_params9_n1000_3.RData")
v1 <- rbind(v1,mfergm_estim)
v2 <- rbind(v2,ergm_sim_estim_tapered)
v3 <- rbind(v3,init_params)
...
load("mfergm_params9_n1000_4.RData")
v1 <- rbind(v1,mfergm_estim)
v2 <- rbind(v2,ergm_sim_estim_tapered)
v3 <- rbind(v3,init_params)
...
load("mfergm_params9_n1000_5.RData")
v1 <- rbind(v1,mfergm_estim)
v2 <- rbind(v2,ergm_sim_estim_tapered)
v3 <- rbind(v3,init_params)
...
load("mfergm_params9_n1000.RData")
}
