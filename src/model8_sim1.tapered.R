...
mv_1 <- c(394, 342, 3000, 180)                   # mean-value parameters for increased transitivity and tapered model
                                                 # 405.95  357.73 3346.61  135.27
                                                 # 365.72  358.97 2759.26  131.63
theta <- c(-1.5263421, 1.4121037,-0.1683131, 0.7811574)
##################
#                #
#     Set-up     #
#                #
...
save.image("mfergm_params7_n1000.RData")
